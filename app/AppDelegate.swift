...
// This file ensures that the application properly interacts with the system
// and other apps on an iOS device (ex: foreground to background execution)
...
class AppDelegate: UIResponder, UIApplicationDelegate, CLLocationManagerDelegate {
    ...
    func locationManager(_ manager: CLLocationManager, didUpdateLocations locations: [CLLocation])
        // obtains up-to-date location information from iOS device
    {
